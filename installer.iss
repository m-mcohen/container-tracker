...
; AppVersion comes from version.iss, generated by tools/release.ps1 (and by
; build.bat as a fallback) from the single source of truth:
; container_tracker/core/constants.py __version__. Do not hardcode it here.
#include "version.iss"
